...
class CalendarList extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      dataSource: Constants.getCalendarDates(
        Constants.validateDate(minDate),
        Constants.validateDate(maxDate),
        firstDayOnWeeks
      ),
    });
  }
  ...
  _selectDate = (date, index) => {
    ...
    onPressDate &&
      ...
      onPressDate(Constants.toStandardStringWith(date), index);
  };
  ...
  render() {
    ...
    const _toolBar = (
      <ToolBar
        ...
        confirm={() => {
          ...
          const dates = [
            Constants.toStandardStringWith(startDate),
            Constants.toStandardStringWith(endDate),
          ];
    ...
    return (
      <View style={containerStyle}>
        ...
        />
        {showToolBar &&
          toolBarPosition === Constants.DEFAULT_TOOL_BAR_POSITION.BOTTOM &&
          _toolBar}
      </View>
    );
  }
...
CalendarList.defaultProps = {
  ...
  showWeeks: true,
  weeks: Constants.DEFAULT_WEEK_KOR,
